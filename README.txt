The "FocusCura" Moodle Theme
======================
FocusCura is a child theme of Essential.
...
Free Software
=============
The FocusCura theme is software under the terms of the GNU GPLv3 License, please see 'COPYING.txt'.

It is a child theme within 'Essential' - folder 'focuscura' can be obtained for free from:
...
============
 ...
 3. Copy the 'focuscura' folder to the '/theme/' folder.
...
=========
 1. Ensure you have the version of Moodle as stated above in 'Required version of Moodle'.  This is essential as the
    theme relies on underlying core code that is out of my control.
 2. Login as an administrator and put Moodle in 'Maintenance Mode' so that there are no users using it bar you as the administrator.
 3. Make a backup of your old 'focuscura' folder in '/theme/' and then delete the folder.
 4. Copy the replacement extracted 'focuscura' folder to the '/theme/' folder.
...
==============
 ...
 3. In '/theme/' remove the folder 'focuscura'.
...
4.  In '/theme/' remove the folder 'focuscura' i.e. ALL of the contents - this is VITAL.
5.  Put in the replacement 'focuscura' folder into '/theme/'.
...
8.  Switch the theme back to 'FocusCura' under 'Home -> Administration -> Site administration -> Appearance -> Themes -> Theme selector ->
    Default'.
...
Documentation
=============
As always, documentation is a work in progress.  Available documentation is available at http://docs.moodle.org/35/en/Essential_theme
